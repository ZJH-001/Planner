  ...
  <view class="container">
    ...
    <view class="friends-section">
      <view class="section-header">
        ...
        <text class="section-more" @tap="navigateTo('/pages/friends/friends')"
          >更多 ></text
        >
      </view>
      <scroll-view
    ...
    <view class="games-section">
      <view class="game-card large" @tap="navigateToCareerAssessment">
        <view class="game-info">
          <text class="game-title">大学生生涯测评</text>
          <text class="game-mode">生涯规划</text>
          <text class="game-players">10道题目</text>
        </view>
        <image
          class="game-icon"
          src="/static/games/holland.png"
          mode="aspectFit"
        ></image>
      </view>

      <view class="games-row">
        <view class="game-card small" @tap="navigateToHolland">
          <view class="game-info">
            <text class="game-title">霍兰德职业兴趣测评</text>
            <text class="game-mode">职业规划</text>
            <text class="game-players">30道题目</text>
          </view>
          <image
        ...
        <view
          class="game-card small yellow"
          @tap="navigateTo('/pages/friends/party')"
        >
          <view class="game-info">
...
export default {
  ...
  methods: {
    ...
    navigateToCareerAssessment() {
      // 跳转到大学生生涯测评
      uni.navigateTo({
        url: "/pages/career-assessment",
      });
    },
    navigateToHolland() {
      // 跳转到霍兰德职业兴趣测评
